...
MeowTV（以下简称"我们"）非常重视用户隐私。本隐私政策说明我们在您使用 MeowTV 应用时收集、使用和保护个人信息的方式。请您在使用本应用前仔细阅读本隐私政策。

一、信息收集

在您使用 MeowTV 时，我们可能收集以下信息：

1. 设备 ID：用于识别您的设备，实现登录设备管理与安全校验。
2. 服务器地址：您手动配置的 MeowTV 后端服务器地址，用于与您的私有服务器通信。
3. 登录凭证（Token）：登录成功后由服务器下发，用于后续请求的身份验证。
4. 设备名称与类型：用于在"在线设备管理"中展示当前登录设备。
5. 播放与搜索历史：由您的 MeowTV 服务器存储，本应用仅在本地缓存以提升使用体验。
...
1. 实现用户登录、身份验证与会话管理。
2. 与您配置的 MeowTV 服务器通信，提供影视搜索、播放、收藏等功能。
3. 在多设备登录场景下提供设备管理能力。
4. 优化应用性能与用户体验。
...
MeowTV 不面向 13 岁以下儿童。我们不会故意收集儿童的个人信息。如果您是儿童的监护人，发现您的孩子向我们提供了个人信息，请联系我们，我们将及时删除相关信息。
...
如果您对本隐私政策有任何疑问或建议，可通过 MeowTV 官方渠道与我们联系。
